...
extension Image {
	...
	@inlinable public static func linearGradient(size width: Int, by height: Int, direction: Angle<Float>, from start: Color, to end: Color) -> Image {
		Image(rawValue: GenImageGradientLinear(width.toInt32, height.toInt32, direction.toDegrees.rounded().toInt32, start.rawValue, end.rawValue))
	}

	@inlinable public static func horizontalGradient(size width: Int, by height: Int, from left: Color, to right: Color) -> Image {
		linearGradient(size: width, by: height, direction: .degrees(90), from: left, to: right)
	}

	@inlinable public static func verticalGradient(size width: Int, by height: Int, from left: Color, to right: Color) -> Image {
		linearGradient(size: width, by: height, direction: .degrees(0), from: left, to: right)
	}

	//MARK: - Radial Gradient

	@inlinable public static func radialGradient(size width: Int, by height: Int, density: Float = 0, from inner: Color, to outer: Color) -> Image {
		Image(rawValue: GenImageGradientRadial(width.toInt32, height.toInt32, density, inner.rawValue, outer.rawValue))
	}

	@inlinable public static func squareGradient(size width: Int, by height: Int, density: Float = 0, from inner: Color, to outer: Color) -> Image {
	...
	@inlinable public static func perlinNoise(size width: Int, by height: Int, offset offsetX: Int, _ offsetY: Int, scale: Float) -> Image {
		Image(rawValue: GenImagePerlinNoise(width.toInt32, height.toInt32, offsetX.toInt32, offsetY.toInt32, scale))
	}

	//MARK: - Text

	@inlinable public static func text(size width: Int, by height: Int, _ string: String) -> Image {
