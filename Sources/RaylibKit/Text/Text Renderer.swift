...
extension Renderer2D {
	...
	@inlinable public static func text(_ value: String, at x: Int, _ y: Int, size: Float = Renderer.pointSize, color: Color = Renderer.textColor) {
		DrawText(value, x.toInt32, y.toInt32, size.toInt32, color.rawValue)
	}
	
	@inlinable public static func text(_ value: String, at x: Int, _ y: Int, size: Float = Renderer.pointSize, alignment: TextAlignment = Renderer.textAlignment, color: Color = Renderer.textColor) {
		DrawText(value, (x + alignment.offset(of: value, at: size)).toInt32, y.toInt32, size.toInt32, color.rawValue)
	}
	
	@inlinable public static func text(center value: String, offset x: Int = 0, _ y: Int = 0, size: Float = Renderer.pointSize, color: Color = Renderer.textColor) {
